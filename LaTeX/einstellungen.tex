...
%% des Dokuments.
\setzematrikelnr{3852430, 7532274}
\setzekurs{ITA15}
\setzetitel{Augmented Reality Multiplayer Spiel}
\setzedatumAbgabe{Juni 2018}
\setzefirma{Daimler AG}
\setzefirmenort{Stuttgart}
\setzeabgabeort{Stuttgart, Deutschland}
\setzeabschluss{Bachelor of Engineering}
\setzestudiengang{IT-Automotive}
\setzedhbw{Stuttgart}
\setzebetreuer{Prof. Dr. Zoltán Zomotor}
%\setzegutachter{Dr.\ Silvana Koch-Mehrin}
\setzezeitraum{36 Wochen}
\setzearbeit{Studienarbeit}
\setzeautor{Philipp Enke und Matthias Billharz}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
