...
%% des Dokuments.
\setzematrikelnr{3852430}
\setzekurs{ITA15}
\setzetitel{Development of a sensor data feedback service for the autonomous driving HD map update}
\setzedatumAbgabe{August 2017}
\setzefirma{Daimler AG}
\setzefirmenort{Stuttgart}
\setzeabgabeort{Sunnyvale, CA, USA}
\setzeabschluss{Bachelor of Engineering}
\setzestudiengang{IT-Automotive}
\setzedhbw{Stuttgart}
\setzebetreuer{Qi Chen}
%\setzegutachter{Dr.\ Silvana Koch-Mehrin}
\setzezeitraum{12 weeks}
\setzearbeit{Project Report}
\setzeautor{Philipp Enke}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
